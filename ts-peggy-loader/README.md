...
# `@davidtorosyan/ts-peggy-loader`

> Typescript Peggy loader for webpack

Forked from [@rocket.chat/peggy-loader](https://github.com/RocketChat/fuselage/tree/develop/packages/peggy-loader).
